  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className="grid">
          <button className="info mobile" onClick={(event) => {
      document.querySelector('.projectForm').classList.toggle("show")
      event.target.classList.toggle("opened")
    }}><GoGear /> <span>Metadata</span></button>
          ...
          <div className="details">
            <form>
              ...
              <textarea value={bin.description} readOnly placeholder="Enter a short description." maxLength={128} name="project-desc"></textarea>
            </form>
          </div>
      ...
      setTimeout(() => {
        ...
        event.target.style.color = "var(--special-color)"
            ...
            <CodeMirror
              ...
              theme={theme=='light' ? githubLight : atomoneInit({
                settings: {
                  caret: "#c6c6c6",
...
if(bin)
  return { props: { bin: JSON.stringify(bin) } };
else return {
      redirect: {
        permanent: false,
        destination: "/404"
